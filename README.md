...
```
cd existing_repo
git remote add origin https://gitlab.com/pooyasabeti97/topdot-website.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/pooyasabeti97/topdot-website/-/settings/integrations)
